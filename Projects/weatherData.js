const project = {
    ...
    details: [
        { icon: "fas fa-calendar-alt", label: "Duration", value: "4 weeks" },
    ...
    features: [
        {
            ...
            description: "This code snippet demonstrates how to update various UI elements...",
            image: "Platypus/UML_Pick-up_System.jpeg",
            alt: "UML Diagram",
  ...
  "openWeatherMapApiKey": "Your_API_key"
            ...
            images: [
                { src: "Platypus/PlayerStateManager-Inspector.jpg", size: "40", alt: "UML Diagram", caption: "Figure 1: UML Diagram" },
                { src: "Platypus/PlayerStateManager-Inspector.jpg", size: "40", alt: "UML Diagram", caption: "Figure 1: UML Diagram" },
                { src: "Platypus/PlayerStateManager-Inspector.jpg", size: "40", alt: "UML Diagram", caption: "Figure 1: UML Diagram" },
                { src: "Platypus/PlayerStateManager-Inspector.jpg", size: "75", alt: "UML Diagram", caption: "Figure 1: UML Diagram" },
                { src: "Platypus/PlayerStateManager-Inspector.jpg", size: "100", alt: "UML Diagram", caption: "Figure 1: UML Diagram" },
                // > 100% fix
                { src: "Platypus/PlayerStateManager-Inspector.jpg", size: "140", alt: "Dash Ability Diagram", caption: "Figure 2: Dash Ability" },
                { src: "Platypus/PlayerStateManager-Inspector.jpg", size: "140", alt: "Dash Ability Diagram", caption: "Figure 2: Dash Ability" }
            ]
        }
    ]
